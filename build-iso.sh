...
ADDITIONAL_PACKAGES="\
    https://github.com/SkorionOS/linux-skorion/releases/download/v6.17.7-3/linux-skchos-6.17.7-3-x86_64.pkg.tar.zst \
	https://github.com/SkorionOS/linux-skorion/releases/download/v6.17.7-3/linux-skchos-headers-6.17.7-3-x86_64.pkg.tar.zst \
"
