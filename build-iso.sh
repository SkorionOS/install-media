...
ADDITIONAL_PACKAGES="\
    https://github.com/SkorionOS/linux-skorion/releases/download/v6.15.9-1/linux-skchos-6.15.9-1-x86_64.pkg.tar.zst \
	https://github.com/SkorionOS/linux-skorion/releases/download/v6.15.9-1/linux-skchos-headers-6.15.9-1-x86_64.pkg.tar.zst \
"
